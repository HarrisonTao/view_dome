...
public class WheelPickerUtils {
     ...
     */
    //条件选择器初始化，自定义布局
    public void initCustomOptionPicker(Context context, final String pickerTitle, ArrayList<WheelPickerBean> list, final CurrentOption option) {
...
//                .isDialog(true)
     ...
     * @param listener
     */
    public void showTimeWheelPicker2(Context context, String title, boolean flag, final TimePickerListener listener) {
...
//                btn_CustomOptions.setText(tx);
    ...
    // 弹出选择器
    public void showAreaPickerView(Context context, String title) {
