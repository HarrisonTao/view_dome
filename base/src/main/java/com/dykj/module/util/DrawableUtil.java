...
public class DrawableUtil {
     ...
     * @param bgColor        背景透明
     */
    public static void setTextStrokeTheme(TextView textView, int strokeWidth, int cornerRadius, int color, int bgColor) {
        textView.getPaint().setFlags(Paint.FAKE_BOLD_TEXT_FLAG);
        textView.getPaint().setAntiAlias(true);//抗锯齿
        textView.setBackgroundDrawable(getStrokeSolidDrawable(cornerRadius, strokeWidth, color, bgColor));
        textView.setTextColor(ColorUtil.getColorStateList(bgColor, color));
    }
    /**
