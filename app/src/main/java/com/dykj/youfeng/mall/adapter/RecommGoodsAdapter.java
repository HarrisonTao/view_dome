 ...
 */
public class RecommGoodsAdapter extends BaseQuickAdapter<GoodsBean, BaseViewHolder> {

    public RecommGoodsAdapter(int layoutResId, List<GoodsBean> data) {
    ...
    protected void convert(BaseViewHolder helper, GoodsBean item) {
        helper.setText(R.id.tv_goods_name, item.goods_name)
                ...
                .setText(R.id.tv_sel_num, "销量" + item.goods_salenum);
